...
public class Converter {
  ...
  public void startConverter(RtdpOptions options) throws IOException {
    ...
    final String datasetId = "acmeiot";
    final String tableName = "acmedevices";
    ...
    public void processElement(ProcessContext c) throws Exception {
      ...
      TableRow row =
          new TableRow()
              ...
              .set("lat", attrs[3])
              .set("lng", attrs[4])
              .set("humidity", new Double(attrs[5]))
              .set("dewpoint", new Double(attrs[6]))
              .set("pressure", new Double(attrs[7]));
      c.output(row);
    }
  }
